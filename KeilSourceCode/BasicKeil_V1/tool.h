...
void helpPrint()
{
	...
	disstring("EXAMPLE:");
	disstring("10 REM Program to add two numbers");
	disstring("20 INPUT a");
	disstring("30 INPUT b");
	disstring("40 LET total = a + b");
	disstring("50 PRINT total");
	disstring("60 END");
}
